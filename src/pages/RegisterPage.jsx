...
const RegisterPage = () => {
  ...
  // Admin registration key (in a real app, this would be securely stored and verified server-side)
  ...
  return (
    <div className="min-h-screen flex">
      {/* Left side - Image */}
      <div className="hidden md:block md:w-1/2 bg-cover bg-center" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1577563908411-5077b6dc7624?q=80&w=2070')" }}>
        <div className="h-full w-full bg-purple-700 bg-opacity-30 flex items-center">
          <div className="px-20 text-white">
            <h1 className="text-4xl font-bold mb-6">Join Our Community</h1>
            <p className="text-xl mb-6">Create an account to get started with your shopping journey.</p>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-md w-full space-y-8">
          ...
          <form className="mt-8 space-y-6" onSubmit={handleRegister}>
            <div className="space-y-4">
              ...
              {/* Admin Key Input (only shown if admin is selected) */}
              {isAdmin && (
                <div>
