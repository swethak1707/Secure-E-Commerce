...
// import { collection, addDoc, getDocs, query, where, updateDoc, doc, deleteDoc, increment } from 'firebase/firestore';
...
//     try {
//       // Get the item to be removed (for stock adjustment)
...
//         // Update product stock in Firestore (add back the removed quantity)
//         try {
  ...
  const checkout = async () => {
    ...
    try {
      ...
      for (const item of cartItems) {
        ...
        const productSnap = await doc(db, 'products', item.id).get();
